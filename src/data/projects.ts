...
export const projects: Project[] = [
  {
    ...
    coverImage: "/images/projects/cover-weave.png",
    featured: true,
    status: "DEVELOPED",
  },
  {
    ...
    coverImage: "/images/projects/cover-datasanity.png",
    featured: true,
    status: "WIP",
  },
  {
    ...
    coverImage: "/images/projects/cover-autolingo.png",
    featured: true,
    status: "DEPLOYED",
  },
  {
    ...
    coverImage: "/images/projects/cover-ace.png",
    featured: true,
    status: "DEVELOPED",
  },
  {
    id: "workbench-rbac",
    slug: "workbench-rbac",
    codename: "WORKBENCH_RBAC",
    title: "Workbench RBAC",
    description:
      "Admin panel for managing roles, permissions, and user access in a workspace. Create custom roles with granular permissions, edit them via a visual matrix, assign multiple roles to users, and preview effective (merged) permissions.",
    longDescription:
      "A role-based access control (RBAC) admin panel for managing team permissions. Create custom roles with granular permissions across projects, tasks, members, billing, and settings. Edit permissions through a visual matrix with per-action toggles. Assign multiple roles to users and preview their effective permissions — resolved as the union of all assigned roles (additive, never subtracted). Uses in-memory data — no database or environment variables needed.",
    tech: ["Next.js 14", "TypeScript", "Tailwind CSS", "Lucide React"],
    githubUrl: "https://github.com/ksploitx/workbench-rbac",
    liveUrl: "https://youtu.be/wX1tTIXmuAg",
    coverImage: "/images/projects/cover-workbench-rbac.png",
    featured: true,
    status: "DEVELOPED",
  },
  {
    ...
    codename: "TICKET_CLASSIFIER",
    title: "Support Ticket Classifier",
    description:
      "Hybrid rule + ML + LLM-fallback system for classifying support tickets into 6 categories. 3-tier architecture balancing speed, cost, and accuracy with a configurable confidence threshold and toggle-able AI fallback.",
    longDescription:
      "A multi-tiered ticket classification system balancing speed, cost, and accuracy. Tier 1 uses rule-based keyword matching for instant classification. Tier 2 falls back to a CalibratedClassifierCV-wrapped LinearSVC model (TF-IDF vectorized) for confidence-scored predictions. Tier 3 optionally routes low-confidence tickets to an LLM (via OpenRouter) as a safety net for ambiguous cases. Includes a Next.js frontend with a toggle to enable/disable the AI fallback tier.",
    tech: ["Python", "FastAPI", "scikit-learn", "Next.js", "TypeScript", "Tailwind CSS", "Docker", "OpenRouter"],
    githubUrl: "https://github.com/ksploitx/support-ticket-classifier",
    coverImage: "/images/projects/cover-ticket-classifier.png",
    featured: true,
    status: "DEVELOPED",
  },
  {
    ...
    coverImage: "/images/projects/cover-portfolio.png",
    featured: true,
    status: "DEPLOYED",
  },
  {
    ...
    coverImage: "/images/projects/cover-pisentinel.png",
    featured: true,
    status: "DEPLOYED",
  },
];
